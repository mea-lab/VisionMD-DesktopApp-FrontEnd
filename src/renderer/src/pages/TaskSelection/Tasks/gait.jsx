    ...
    >
      ...
      {showCameraProperties && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-[#333338] border border-zinc-500 p-4 rounded-lg shadow-lg relative w-96">
            <h2 className="text text-gray-100 border-b border-zinc-500 flex justify-between bg-[#333338] py-2 mb-2">
